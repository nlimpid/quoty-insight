...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(QuotePrice::Sequence)
                            .big_integer()
                            .default(0),
                    )
                    ...
                    .col(
                        ColumnDef::new(QuotePrice::Timestamp)
                            .big_integer()
                            .not_null(),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(QuoteTrade::Sequence)
                            .big_integer()
                            .not_null()
                            .default(0),
                    )
                    ...
                    .col(
                        ColumnDef::new(QuoteTrade::Timestamp)
                            .big_integer()
                            .not_null(),
                    )
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(QuotePrice::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(QuoteTrade::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(QuoteSub::Table).to_owned())
            .await?;
        Ok(())
    }
}
